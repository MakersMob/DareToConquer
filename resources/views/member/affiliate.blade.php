@extends('layouts.app', ['title' => 'Dare to Conquer Affiliate Program'])
...
<section class="welcome">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<h1 class="billboard"><strong>The Affiliate Program</strong></h1>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		<div class="row">
			<div class="col-12 col-lg-8">
				<p>Enjoying Dare to Conquer and want to recommend it to your audience while also making some money of your own?</p>
				<p>Excellent!</p>
				<p>The affiliate program is pretty simple. You get 40% of any sales on any DTC product.</p>
				<ul>
					<li>If someone purchases the Pinterest course you get 40%.</li>
					<li>If someone purchases the Affiliate Marketing course you get 40%.</li>
					<li>If someone purchases the Pro Membership you get 40%.</li>
				</ul>
				<p>Over time I'll offer new ways to up your percentage.</p>
				<p>Cookies last for 30 days so plenty of time for people to go through the free 12-Day Blogging Bootcamp and make a decision.</p>
